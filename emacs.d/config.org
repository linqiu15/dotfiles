...
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq
   python-shell-interpreter "~/python314/bin/python3"
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package org-bars
    :load-path "~/.emacs.d/site-lisp/org-bars/"
    :config
    (add-hook 'org-mode-hook #'org-bars-mode)
    )

  ;; (use-package iscroll
  ;;   :load-path "~/.emacs.d/site-lisp/iscroll/"
  ;;   :config
...
#+begin_src emacs-lisp :tangle yes
  ...
  (setq org-capture-templates
  	...
  	("t" "Todo" entry (file org-gtd-file)
  	 "* TODO %?\n%i")
  	("e" "emacs task" entry (file org-gtd-file)
  	 "* TODO %?\n%a")
  ...
  (setq org-todo-keywords
  	...
  	(sequence "MEET(m)" "|" "MET(n!)" "CANCELED(c@)")))
#+end_src
** org-journal
#+begin_src emacs-lisp :tangle yes
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package typst-preview
    :load-path "~/.emacs.d/site-lisp/typst-preview.el/"
    ;; :config
    ;; (setq typst-preview-browser "preview") ;; default is "default"
    )
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  ...
  ;;   :pin melpa-stable
  ;;   :bind ("C-c k" . 'khoj)
  ;;   :config (setq khoj-api-key "kk-ribpOx_LfkFwo5fzGdZeWWRz-UsGMPbp-Zdy1rscEbg"
