...
#+begin_src emacs-lisp :tangle yes
  ;; ;; 设置 mu4e 的路径
  ;; (add-to-list 'load-path "/opt/homebrew/Cellar/mu/1.12.9/share/emacs/site-lisp/mu/mu4e/")
...
#+begin_src emacs-lisp :tangle yes
  ...
  (use-package elfeed-org
    ...
    :config
    (elfeed-org)
    (setq rmh-elfeed-org-files (list "~/Nutstore Files/Nutstore/org/elfeed.org")))
#+end_src
** deft
#+begin_src emacs-lisp :tangle yes
  (use-package deft
